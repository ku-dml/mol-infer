...
echo LR Bp start
python3 SINGLE_eval.py   $Module_1_output/Bp_small_desc_norm.csv sample_instance/input/Bp_small_norm_values.txt  -o  sample_instance/output/Bp_small_LLR  -l 0.00019
