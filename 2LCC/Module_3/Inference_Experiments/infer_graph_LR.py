...
value_file = "/Users/sbw/Desktop/Project_CC/src/Module_3/MILP_INSTANCE_RESULT_USED_IN_PAPER/instance/IhcLiq/IhcLiq_values(value_file).txt" # The observed value of the dataset that you use to construct the prediction function
original_data_file = "/Users/sbw/Desktop/Project_CC/src/Module_3/MILP_INSTANCE_RESULT_USED_IN_PAPER/instance/IhcLiq/IhcLiq_C_O_N_H_desc(original_data_file).csv" # Feature vector of dataset
fv_fringe_file = "/Users/sbw/Desktop/Project_CC/src/Module_3/MILP_INSTANCE_RESULT_USED_IN_PAPER/instance/IhcLiq/IhcLiq_C_O_N_H_fringe(fv_fringe_file).txt" # The fringe file of dataset that generated by feature function.

### Parameter for Instance ###
LR_file = "/Users/sbw/Desktop/Project_CC/src/Module_3/MILP_INSTANCE_RESULT_USED_IN_PAPER/instance/IhcLiq/IhcLiq_LR(LR_file).txt" # The path of prediction function of hyperplane
seed_tree_file = "/Users/sbw/Desktop/Project_CC/src/Module_3/MILP_INSTANCE_RESULT_USED_IN_PAPER/instance/IhcLiq/IhcLiq_3_a0(seed_tree_file).txt" #The path of seed tree
seed_tree_fringe_file = "/Users/sbw/Desktop/Project_CC/src/Module_3/MILP_INSTANCE_RESULT_USED_IN_PAPER/instance/IhcLiq/IhcLiq_C_O_N_H_fringe(fv_fringe_file).txt" # The path of fringe file of seed tree

### Parameter for Output chemical graph ###
instance_name = "IhcLiq_3_a0_ex" # Define the name of output chemical graph
output_path = "/MILP_INSTANCE_RESULT_USED_IN_PAPER/result/IhcLiq/IhcLiq_3_a0_ex.sdf" # Output inferred chemical graph
value_of_var = "/MILP_INSTANCE_RESULT_USED_IN_PAPER/result/value_of_var/IhcLiq_3_a0_ex_value.txt" #Used to output the solution values of MILP variables.
...
def main(target_value_lb,target_value_ub):
...
if __name__ == "__main__":
    ...
    # Input by user self #
    # main(target_value_lb,target_value_ub)

    # Experiment for the paper #
    main(float(75.32), float(1956.1))  # If you want to do experiment for "Ihcliq"
    # main(float(-117), float(165)) # OptR
    # main(float(0.554), float(25.2)) #vd
    # main(float(-7.53), float(15.6)) #kow
