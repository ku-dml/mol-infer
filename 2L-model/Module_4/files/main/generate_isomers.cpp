...
int main(int argc, char** argv) {
  ...
  for (size_t i = 0; i < base_vertices.size(); ++i) {
    ...
    // input_info IN_INFO;
    get_descriptors_tree(_cp.IN_INFO, g, core_set, internal_set, v, g_atom_set);
  ...
  for (size_t i = 0; i < base_edges.size(); ++i) {
    ...
    _cp.no_feasible_pair = false;
    _cp.with_core_height = false;
    get_descriptors_edge(_cp.IN_INFO, g, core_set, internal_set, e, g_atom_set);
