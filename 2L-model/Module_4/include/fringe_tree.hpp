  ...
  for (unsigned short a = 0; a < M; ++a) {
    ...
    for (size_t i = 0; i < IN_INFO.fringe_tree_indices.size(); ++i){
      ...
      if (IN_INFO.find_index(TS_tmp.delta_2[0]) == a){
        ...
        if (FT.height == 2 && FT.root_val + 1 <= IN_INFO.atoms[a].VALENCE){
  ...
  for (unsigned short a = 0; a < M; ++a) {
    ...
    for (size_t i = 0; i < IN_INFO.fringe_tree_indices.size(); ++i){
      ...
      if (IN_INFO.find_index(TS_tmp.delta_2[0]) == a){
        ...
        if (FT.root_val + 2 <= IN_INFO.atoms[a].VALENCE){
  ...
  for (unsigned short a = 0; a < M; ++a) {
    ...
    for (size_t i = 0; i < IN_INFO.fringe_tree_indices.size(); ++i){
      ...
      if (IN_INFO.find_index(TS_tmp.delta_2[0]) == a){
        ...
        if (FT.root_val + delta_i <= IN_INFO.atoms[a].VALENCE){
