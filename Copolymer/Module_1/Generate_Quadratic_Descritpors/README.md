...
This folder contains the code to generate the quadratic descriptors used in the learning method R-MLR.
...
Here:
- DATASET_desc_norm.csv: the linear descriptor file generated by [Generate Linear Desciptors](/Copolymer/Module_1/Generate_Linear_Descriptors);
