...
def create_base_MILP(MILP, instance_file, fringe_tree_file, original_dataset_filename):
    ...
    set_F, Lambda_ex, strF, fc_LB, fc_UB = prepare_fringe_trees(
        fringe_tree_file, Lambda
    )
    ...
    Gamma_lf_ac, ac_LB_lf, ac_UB_lf = prepare_Gamma_lf_ac(
        set_Lambda, ac_LB_lf, ac_UB_lf, ac_LB_lf_common, ac_UB_lf_common
    )

    Lambda_tilde_dg_C, Lambda_tilde_dg_T, Lambda_tilde_dg_F = prepare_Lambda_tilde(
        Lambda_dg_int
    )
    ...
    (
        ...
        I_equal_one_minus,
        delta_i,
    ) = prepare_dataset_for_scheme_graph(
        n_star,
        rho,
        V_C,
        E_C,
    ...
    (
        ...
        n_G_int,
        rank_G,
    ) = prepare_variables_selecting_core(
    ...
    (
        ...
        delta_chi_F,
        bl,
    ) = prepare_variables_internal_vertices_and_edges(
        t_F,
        t_T,
        t_C,
        t_C_tilde,
    ...
    (
        ...
        sigma,
        ac_lf,
    ) = prepare_variables_fringe_trees(
        n_LB,
        n_star,
        rho,
        ch_LB,
    ...
    (
        ...
        bd_CF,
        bd_TF,
    ) = prepare_variables_multiplicity(
        t_C,
        t_T,
        t_F,
        n_C,
    ...
    (
        ...
        na_ex_F,
        na_ex,
    ) = prepare_variables_chemical_elements(
        t_C,
        t_T,
        t_F,
        n_C,
    ...
    ns_int, delta_ns_C, delta_ns_T, delta_ns_F = prepare_variables_chemical_symbols(
        t_C,
        t_T,
        t_F,
        n_C,
    ...
    fc = prepare_variables_fringe_configuration(
    ...
    MILP = add_constraints_fringe_configuration(
        MILP, t_C, t_T, t_F, set_F, Code_F, delta_fr_C, delta_fr_T, delta_fr_F, fc
    )
