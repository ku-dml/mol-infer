...
Here:
- RES.sdf: the generated chemical graph in sdf format obtained in [Module 3](/chi_parameter/Module_3);
...
- RES_partition.txt: file containing the partition information of RES.sdf obtained in [Module 3](/chi_parameter/Module_3), and
- FRINGE.txt: file containing the information of available fringe trees used as part of input for [Module 3](/chi_parameter/Module_3) to obtain RES.sdf.
