...
def forward_stepwise_selection(X, y, num_descriptors, regression_type, alpha=0.00001):
...
def main(args):
    ...
    selected_descriptors = feature_df.columns[1:-1][selected_features_indices]
...
if __name__ == '__main__':
    args = (0, "Phys_desc_norm.csv", "Phys_logS_norm.txt", 66, "multi")
    main(args)